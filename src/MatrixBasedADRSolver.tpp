...
namespace MFSolver
{
    ...
    void MatrixBasedADRSolver<dim, fe_degree>::setup_system()
    {
        ...
        // Initialize the linear system.
        {
            ...
            system_rhs = TrilinosWrappers::MPI::Vector(locally_owned_dofs, MPI_COMM_WORLD);

            pcout << "  Initializing owned solution" << std::endl;
            solution_owned = TrilinosWrappers::MPI::Vector(locally_owned_dofs, MPI_COMM_WORLD);

            pcout << "  Initializing solution" << std::endl;
            solution = TrilinosWrappers::MPI::Vector(locally_owned_dofs, locally_relevant_dofs, MPI_COMM_WORLD);
        }
    }
